...
from src.day5_pt1 import convert_to_table_and_instructions, convert_table_to_array, main, convert_instruction_str_to_int, make_move
...
def test_convert_to_table_and_instructions(inputs_dir):
    ...
    assert instructions == ['move 1 from 2 to 1',
                            'move 3 from 1 to 3',
                            'move 2 from 2 to 1',
                            'move 1 from 1 to 2']
