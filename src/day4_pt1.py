...
def contained(elf_1_start: int, elf_1_end: int, elf_2_start: int, elf_2_end: int):
...
def main(file_path: Path):
    ...
    for line in read_lines(file_path):
        ...
        pairs_assigned += contained(int(elf_1_start), int(elf_1_end), int(elf_2_start), int(elf_2_end))
